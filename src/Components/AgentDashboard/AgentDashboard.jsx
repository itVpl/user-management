...
useEffect(() => {
  const fetchPresentDaysCount = async () => {
    try {
      const response = await axios.get('https://vpl-liveproject-1.onrender.com/api/v1/attendance/my/present-count');
      setPresentDaysCount(response.data.count || 0);
    } catch (err) {
      console.error("Failed to fetch present count", err);
    }
  };

  fetchPresentDaysCount();
}, []);
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">2 min 15sec</span>
                </div>
                <div className="flex justify-between">
