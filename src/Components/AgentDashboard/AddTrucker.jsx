...
export default function AddTruckerForm() {
  ...
  return (
    <div className="h-[70] flex items-center justify-center bg-gradient-to-b from-blue-200 to-blue-400 p-4">
      <form
      ...
      >
        ...
        <div className="text-center space-y-2">
          <h2 className="text-xl font-semibold">Upload Customer Verification</h2>
