    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-96 bg-white p-4 border-r overflow-y-auto rounded-r-2xl shadow-md">
        ...
        {consignments.length === 0 ? (
          <p className="text-gray-500 text-sm text-center">No shipment found.</p>
        ) : (
          consignments.map((item) => (
            <div
              key={item.id}
              className="bg-gray-50 shadow rounded-lg p-4 mb-3"
            ...
            >
              <div className="flex justify-between items-center cursor-pointer">
                ...
                <div className="text-lg">
                  {expandedId === item.id ? <img src={ArrowUp} /> : <img src={ArrowDown} />}
                </div>
              </div>
