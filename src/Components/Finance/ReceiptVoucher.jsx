...
export default function ReceiptVoucher({ selectedCompanyId = null, globalRange }) {
  const [searchTerm, setSearchTerm] = useState('');
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.receiptAccount || formData.receiptAccount.trim() === '') {
      alertify.error('Please select a Receiver Account');
      return;
    }
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-gray-100 to-gray-200">
                  <tr>
                    ...
                    <th className="text-left py-3 px-3 text-gray-800 font-bold text-sm uppercase tracking-wide">Receiver Account</th>
                      ...
                      <div>
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            setFormData({ ...formData, company: value, receiptAccount: '' });
                            setCompanyId(value);
                            if (value) {
            ...
            <div className="p-6 space-y-6">
              <div className="bg-green-50 rounded-2xl p-4">
                ...
                <div className="grid grid-cols-2 gap-4 bg-white border border-green-200 rounded-xl p-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Receiver Account</p>
                    <p className="font-semibold text-gray-800">
