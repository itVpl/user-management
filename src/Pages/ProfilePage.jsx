...
const ProfilePage = () => {
      ...
      if (!date) {
        ...
        const mapped = list.map((c) => {
          ...
          return {
            ...
            "Last company name": c?.lastCompany ?? c?.lastCompanyName ?? "",
            lastCompanyName: c?.lastCompany ?? c?.lastCompanyName ?? "",
            "English Fluency": c?.englishFluency ?? "",
            englishFluency: c?.englishFluency ?? "",
  ...
  const getLogVal = (log, key) => {
    ...
    const map = {
      ...
      Age: () => log.Age ?? log.age ?? cd.age,
      Gender: () => log.Gender ?? log.gender ?? cd.gender,
